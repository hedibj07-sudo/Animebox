            ...
            {searchQuery.trim().length > 1 ? (
              ...
              <>
                ...
                <button
                  onClick={openQuiz}
                  className="st-btn"
                  style={{ width: "100%", marginTop: 24, display: "flex", alignItems: "center", gap: 12, background: `linear-gradient(135deg, ${PALETTE.blue}, #7A5CFF)`, border: "none", borderRadius: 18, padding: "16px 18px", cursor: "pointer", textAlign: "left" }}
                >
                  <span style={{ fontSize: 26 }}>🎲</span>
                  <span>
                    <span className="st-title" style={{ display: "block", fontSize: 15, fontWeight: 800, color: "#fff" }}>Je ne sais pas quoi regarder</span>
                    <span style={{ display: "block", fontSize: 12, color: "rgba(255,255,255,0.8)", marginTop: 2 }}>3 questions, et on te propose un anime</span>
                  </span>
                </button>
        ...
        {NAV_ITEMS.map((item) => {
          ...
          return (
            <button
              ...
              className="st-btn"
              style={{ background: "none", border: "none", cursor: "pointer", display: "flex", flexDirection: "column", alignItems: "center", gap: 3, color: active ? PALETTE.blue : PALETTE.muted, padding: "4px 10px" }}
            >
              <Icon size={20} />
              ...
              <>
                ...
                {!quizLoading && quizError && (
                  <div style={{ textAlign: "center", padding: "20px 0" }}>
                    ...
                    <button onClick={() => runQuiz(quizAnswers)} className="st-btn" style={{ padding: "10px 20px", borderRadius: 999, border: "none", background: PALETTE.blue, color: "#fff", fontWeight: 800, cursor: "pointer" }}>Réessayer</button>
                  </div>
                )}
                  ...
                  <>
                    ...
                    <div style={{ display: "flex", gap: 14, marginBottom: 18 }}>
                      ...
                      <div>
                        ...
                        {quizPick.score && <div style={{ fontSize: 12, color: PALETTE.gold, marginTop: 4 }}>★ {quizPick.score} sur AniList</div>}
                      </div>
                    </div>
                    <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
                      <button onClick={acceptQuizPick} className="st-btn" style={{ padding: "13px 0", borderRadius: 999, border: "none", background: PALETTE.blue, color: "#fff", fontWeight: 800, fontFamily: "'Baloo 2', sans-serif", fontSize: 15, cursor: "pointer" }}>
                        🍿 Je regarde ça
                      </button>
          ...
          <div onClick={(e) => e.stopPropagation()} style={{ background: PALETTE.surface, borderRadius: 20, padding: 18, maxWidth: 420, width: "100%", maxHeight: "70vh", overflowY: "auto" }}>
            ...
            {friendProfiles.length === 0 ? (
              ...
              friendProfiles.map((p) => (
                ...
                >
                  <div style={{ width: 36, height: 36, borderRadius: "50%", background: PALETTE.blue, display: "flex", alignItems: "center", justifyContent: "center", fontSize: 14, fontWeight: 800, color: "#fff", flexShrink: 0 }}>
