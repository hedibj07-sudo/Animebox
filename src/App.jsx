            ...
            {draftStatus !== "a_voir" && (
              <div style={{ marginBottom: 18 }}>
                ...
                <div style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 16, background: PALETTE.surfaceAlt, borderRadius: 14, padding: "10px 14px" }}>
                  <button onClick={() => bumpEpisode(-1)} className="st-btn" style={{ background: PALETTE.surface, border: "none", borderRadius: 999, width: 34, height: 34, display: "flex", alignItems: "center", justifyContent: "center", color: PALETTE.text, cursor: "pointer" }}><Minus size={16} /></button>
                  <div className="st-title" style={{ fontSize: 16, fontWeight: 800, minWidth: 70, textAlign: "center" }}>
                    Ép. {draftEpisode} / {draftTotalEpisodes || "?"}
                  </div>
                  <button onClick={() => bumpEpisode(1)} className="st-btn" style={{ background: PALETTE.blue, border: "none", borderRadius: 999, width: 34, height: 34, display: "flex", alignItems: "center", justifyContent: "center", color: "#fff", cursor: "pointer" }}><Plus size={16} /></button>
                </div>
              </div>
            )}
