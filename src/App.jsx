...
export default function App() {
  ...
  /* --- photo de profil (avec recadrage) --- */
  ...
  useEffect(() => {
    (async () => {
      ...
      try {
        ...
        setTopAnime((json.data.Page.media || []).map(fromAniList));
      } catch (e) {
    ...
    return (
      <div className="st-body" style={{ background: PALETTE.bg, minHeight: "100vh", color: PALETTE.text, padding: "48px 20px" }}>
        ...
        <div style={{ maxWidth: 420, margin: "0 auto" }}>
          ...
          {justConfirmed && (
            <div style={{ background: PALETTE.surface, border: `1px solid ${PALETTE.line}`, borderRadius: 14, padding: "14px 16px", marginBottom: 20 }}>
              <div style={{ fontSize: 14, fontWeight: 800 }}>✅ Compte confirmé !</div>
              <div style={{ fontSize: 13, color: PALETTE.muted, marginTop: 2 }}>Connecte-toi ci-dessous pour continuer.</div>
            </div>
          )}

          <div style={{ display: "flex", gap: 6, background: PALETTE.surface, padding: 5, borderRadius: 999, marginBottom: 20 }}>
            <button onClick={() => setAuthMode("signin")} className="st-btn" style={{ flex: 1, padding: "10px 0", borderRadius: 999, border: "none", cursor: "pointer", fontWeight: 800, fontFamily: "'Baloo 2', sans-serif", background: authMode === "signin" ? PALETTE.accent : "transparent", color: authMode === "signin" ? PALETTE.accentText : PALETTE.muted }}>Connexion</button>
            <button onClick={() => setAuthMode("signup")} className="st-btn" style={{ flex: 1, padding: "10px 0", borderRadius: 999, border: "none", cursor: "pointer", fontWeight: 800, fontFamily: "'Baloo 2', sans-serif", background: authMode === "signup" ? PALETTE.accent : "transparent", color: authMode === "signup" ? PALETTE.accentText : PALETTE.muted }}>Créer un compte</button>
          </div>
          ...
          <form onSubmit={handleAuthSubmit} style={{ display: "flex", flexDirection: "column", gap: 10 }}>
            ...
            <button type="submit" disabled={authBusy} className="st-btn" style={{ padding: "14px 0", borderRadius: 999, border: "none", background: PALETTE.accent, color: PALETTE.accentText, fontWeight: 800, fontFamily: "'Baloo 2', sans-serif", fontSize: 16, cursor: "pointer" }}>
      ...
      <div className="st-body" style={{ background: PALETTE.bg, minHeight: "100vh", color: PALETTE.text, padding: "48px 20px", display: "flex", alignItems: "center" }}>
        ...
        <div style={{ maxWidth: 420, margin: "0 auto", width: "100%" }}>
          ...
          <form onSubmit={saveUsername} style={{ display: "flex", flexDirection: "column", gap: 10 }}>
            ...
            <button type="submit" disabled={usernameBusy} className="st-btn" style={{ padding: "14px 0", borderRadius: 999, border: "none", background: PALETTE.accent, color: PALETTE.accentText, fontWeight: 800, fontFamily: "'Baloo 2', sans-serif", fontSize: 16, cursor: "pointer" }}>
    ...
    <div className="st-body" style={{ background: PALETTE.bg, minHeight: "100vh", color: PALETTE.text, paddingBottom: 100 }}>
              ...
              <div style={{ position: "relative", width: 56, height: 56, flexShrink: 0 }}>
                ...
                >
                  {myProfile.avatar_url ? (
                    <img src={myProfile.avatar_url} alt="" style={{ width: "100%", height: "100%", objectFit: "cover", opacity: avatarBusy ? 0.5 : 1 }} />
                  ) : (
      ...
      <div style={{ position: "fixed", bottom: 0, left: 0, right: 0, background: PALETTE.surface, borderTop: `1px solid ${PALETTE.line}`, display: "flex", alignItems: "center", justifyContent: "space-around", padding: "10px 12px calc(10px + env(safe-area-inset-bottom))", zIndex: 40 }}>
        {NAV_ITEMS.map((item) => {
          ...
          if (item.key === "add") {
            return (
              <button key={item.key} onClick={() => setShowAddSearch(true)} className="st-btn" style={{ background: PALETTE.accent, border: "none", borderRadius: "50%", width: 52, height: 52, display: "flex", alignItems: "center", justifyContent: "center", cursor: "pointer", marginTop: -22, boxShadow: "0 6px 16px rgba(0,0,0,0.35)" }}>
          ...
          return (
            <button
              key={item.key}
              onClick={() => {
                if (item.key === "accueil" && tab === "accueil") window.scrollTo({ top: 0, behavior: "smooth" });
          ...
          <div style={{ background: PALETTE.surface, padding: "18px 20px", display: "flex", flexDirection: "column", gap: 14 }}>
            ...
            <div style={{ display: "flex", gap: 10 }}>
              ...
              <button
                ...
                disabled={avatarBusy}
                className="st-btn"
                style={{ flex: 1, padding: "13px 0", borderRadius: 999, border: "none", background: PALETTE.accent, color: PALETTE.accentText, fontWeight: 800, fontFamily: "'Baloo 2', sans-serif", cursor: "pointer" }}
              >
              ...
              <>
                ...
                {!quizLoading && !quizError && quizPick && (
                  <>
                    ...
                    <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
                      <button onClick={acceptQuizPick} className="st-btn" style={{ padding: "13px 0", borderRadius: 999, border: "none", background: PALETTE.accent, color: PALETTE.accentText, fontWeight: 800, fontFamily: "'Baloo 2', sans-serif", fontSize: 15, cursor: "pointer" }}>
          ...
          <div onClick={(e) => e.stopPropagation()} style={{ background: PALETTE.surface, borderRadius: 22, padding: 24, maxWidth: 420, width: "100%", maxHeight: "85vh", overflowY: "auto" }}>
            ...
            <div style={{ display: "flex", gap: 10, marginTop: 18, justifyContent: "space-between" }}>
              ...
              <div style={{ display: "flex", gap: 10 }}>
                ...
                <button onClick={saveEntry} className="st-btn" style={{ padding: "10px 20px", borderRadius: 999, border: "none", background: PALETTE.accent, color: PALETTE.accentText, fontWeight: 800, fontFamily: "'Baloo 2', sans-serif", cursor: "pointer" }}>Enregistrer</button>
              </div>
            </div>
          </div>
        </div>
